          ...
          <div className="flex flex-col min-h-screen bg-white  ">
            ...
            <div className="flex flex-col w-100 md:flex-row   overflow-hidden p-2 md:p-8 ">
              ...
              <div className="flex-1 md:mr-4 space-y-4 overflow-hidden p-2">
                ...
                {
                  loading ? (
                    <CustomCardLoader viewBox="0 0 380 80" className="rounded-lg" rectW="100%" rectH="20" />
                  ) : (
                    questions && questions[index]?.showHints && Number(questions[index]?.showHints) > 0 && (
                      <div className="mb-4 rounded-lg shadow">
                        ...
                        <div
                          ...
                          style={{ height: showHints ? panelHeight : 0 }}
                        >
