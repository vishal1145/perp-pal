    ...
    <div className="h-screen overflow-auto">
      <div className="container mx-auto rounded-lg bg-gray-50 p-8 shadow-md">
        ...
        <p className="my-6 text-gray-600">
          At Preppal, we are committed to protecting your privacy and ensuring
          ...
          your personal information when you use our website located at{" "}
          <a
        ...
        <ul className="mb-4 list-inside list-disc pl-5 text-gray-600">
          <li>
            ...
            you personally, such as your name, email address, postal address,
        ...
        <ul className="mb-6 list-inside list-disc pl-5 text-gray-600">
          <li>To provide and maintain our website and services.</li>
          <li>
            To improve the user experience and personalize your interactions
            with our site.
          </li>
          <li>
            To communicate with you, including sending updates, promotions, and
            information related to your account.
          </li>
          <li>To analyze and monitor usage trends and website performance.</li>
          <li>
            To comply with legal obligations or to protect our legal rights.
          </li>
        </ul>
        ...
        <ul className="mb-4 list-inside list-disc pl-5 text-gray-600">
          <li>
            ...
            conducting our business, such as payment processors, hosting
            providers, and marketing partners.
          </li>
          <li>
            If required by law, to comply with legal processes, or in response
            to lawful government requests.
          </li>
          <li>
        ...
        <p className="my-6 text-gray-600">
          ...
          electronic storage method is 100% secure, so we cannot guarantee the
        ...
        <p className="my-6 text-gray-600">You have the right to:</p>
        <ul className="mb-4 list-inside list-disc pl-5 text-gray-600">
          ...
          <li>
            Object to or restrict the processing of your personal information in
            certain circumstances.
          </li>
          <li>
            Withdraw your consent to our processing of your personal data at any
            time, where we rely on your consent to process your data.
          </li>
        </ul>
        ...
        <p className="my-6 text-gray-600">
          ...
          of any sites you visit through external links.
        </p>
        ...
        <p className="my-6 text-gray-600">
          ...
          under 13. If we learn that we have collected personal information from
        ...
        <p className="my-6 text-gray-600">
          ...
          page. Your continued use of our website after the changes are posted
        ...
        <p className="my-6 text-gray-600">
          ...
          we handle your personal information, you can contact us at:
        </p>
        <ul className="mb-4 list-inside list-disc pl-5 text-gray-600">
          <li>
            Email:{" "}
