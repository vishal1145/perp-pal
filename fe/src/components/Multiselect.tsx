...
const DropdownSearch: React.FC<DropdownSearchProps> = ({ filter, options, filterOptionSelect }) => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div id="dropdownSearch" className="z-10 bg-white rounded-lg shadow w-full">
          <div className="p-3 fontSize-filter font-normal text-gray-500">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full p-2 ps-10 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Search..."
                value={searchQuery}
          ...
          <ul className="h-48 px-3 pb-3 overflow-y-auto" aria-labelledby="dropdownSearchButton">
            {filteredOptions.map(item => (
              <li key={item.id}>
                <div className="flex items-center ps-2 font-normal rounded hover:bg-gray-100">
                  <input
